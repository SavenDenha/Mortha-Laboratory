...
cat("Number of triplet interactions with an average distance ", threshold_distance/3, " microns: ", nrow(triplet), "\n")



background_path <- "C:/Users/Saven Denha/Desktop/Kyle/February 2, 2024/Control/control_processed.jpg"
